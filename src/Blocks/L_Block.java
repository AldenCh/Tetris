...
public class L_Block extends Block{
	// Position is based on the center tile
	//    *	   *	  v   **
	//	***	   * <	 ***   * <
	//   ^	   **	 *     *
	...
	public void rotateLeft() {
		...
		if (orientation == 1) {
			...
			tiles.add(temp3);
			Integer[] temp4 = {position[0]-1, position[1]-1};
			tiles.add(temp4);
		}
		else if (orientation == 2){
			Integer[] temp1 = {position[0]-1, position[1]};
			tiles.add(temp1);
			...
			Integer[] temp1 = {position[0], position[1]-1};
			tiles.add(temp1);
			Integer[] temp2 = {position[0]+1, position[1]+1};
			tiles.add(temp2);
			Integer[] temp3 = {position[0], position[1]};
			tiles.add(temp3);
	...
	public boolean canRotateLeft(GamePanel board) {
		if (orientation == 1) {
			...
			if (board.getTile(position[0], position[1]-1) == Color.black || 
				board.getTile(position[0]+1, position[1]+1) == Color.black || 
				board.getTile(position[0], position[1]+1) == Color.black) {
				return false;
			}
	...
	public boolean canMoveDown(GamePanel board) {
		if (orientation == 1) {
			...
			else if (board.getTile(position[0], position[1]+2) == Color.black || 
			...
			else if (board.getTile(position[0]-1, position[1]+2) == Color.black || 
					 board.getTile(position[0], position[1]+1) == Color.black || 
					 board.getTile(position[0]+1, position[1]+1) == Color.black) {
				return false;
			}
	...
	public boolean canMoveRight(GamePanel board) { 
		if (orientation == 1) {
			...
			else if (board.getTile(position[0]+2, position[1]-1) == Color.black || 
